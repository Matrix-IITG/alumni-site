    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostel', models.CharField(choices=[('Siang', 'Siang'), ('Lohit', 'Lohit'), ('Manas', 'Manas'), ('Dhing', 'Dhing'), ('Barak', 'Barak'), ('Umiam', 'Umiam'), ('Subhansari', 'Subhansari'), ('Dibang', 'Dibang'), ('Kapili', 'Kapili'), ('Dhansari', 'Dhansari')], max_length=100)),
